		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="clearfix">
					...
					<a class="btn btnlink sml-link-panel" th:href="@{/titulos/}">Voltar
						para pesqusisa</a>
				</div>
			</div>
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select class="form-controle" name="status" th:field="*{status}"> <!-- th:field="*{mais a o objeto a ser recuperado e mantido}" -->
